...
import { AuthScope, JwtPayload, normalizeVelonRole, VelonRole, isPlatformRole } from "@velon/shared";
...
export class JwtStrategy extends PassportStrategy(Strategy) {
  ...
  async validate(payload: JwtPayload): Promise<AuthenticatedUser> {
    ...
    const scope: AuthScope = payload.scope ?? (isPlatformRole(payload.role) ? "platform" : "tenant");
