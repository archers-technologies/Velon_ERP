import { VELON_CONTACT_ADDRESS, VELON_CONTACT_EMAIL, VELON_CONTACT_PHONE } from '@velon/shared';
...
export const CMS_DEFAULTS = {
    ...
    items: [
      {
        ...
        description: 'Users, departments, seats, and audit in one place.',
      },
    ...
    items: [
      {
        ...
        a: 'Go to Settings → Admin → Invitations after signing up.',
      },
  ...
  testimonials: {
    items: [
      {
        quote: 'Velon gave us a real ERP feel from day one.',
  ...
  privacy: {
    ...
    description: 'How Velon-ERP collects, uses, retains, and protects personal and business data.',
