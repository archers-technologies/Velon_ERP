...
describe('SuppliersService', () => {
  const suppliers = createRepoMock(['findMany', 'findById', 'findByCode', 'create', 'update']);
  ...
  it('returns not found for missing supplier', async () => {
    ...
    await expect(service.getSupplier(tenantOwner(), 'missing')).rejects.toThrow(NotFoundException);
  });
