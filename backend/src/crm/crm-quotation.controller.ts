...
export class CrmQuotationController {
  ...
  expire(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string, @Req() req: Request) {
    return this.quotations.expireQuotation(user, id, reqMeta(req));
  }

  @Post('quotations/:id/clone')
  clone(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string, @Req() req: Request) {
  ...
  removeItem(@CurrentUser() user: AuthenticatedUser, @Param('id') id: string, @Req() req: Request) {
  ...
  @Get('proposals')
  listProposals(@CurrentUser() user: AuthenticatedUser, @Query('quotationId') quotationId: string) {
  ...
  createTemplate(
    @CurrentUser() user: AuthenticatedUser,
    @Body() dto: CreateCrmProposalTemplateDto,
  ) {
