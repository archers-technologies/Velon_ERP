...
export declare function subscriptionAllowsWorkspaceAccess(status: SubscriptionBillingStatus): boolean;
export declare function subscriptionAllowsBillingPortal(status: SubscriptionBillingStatus): boolean;
export declare function mapSubscriptionStatusToTenantStatus(status: SubscriptionBillingStatus): 'ACTIVE' | 'TRIAL' | 'PAST_DUE' | 'SUSPENDED';
