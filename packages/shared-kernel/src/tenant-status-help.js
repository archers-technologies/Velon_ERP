...
exports.TENANT_STATUS_COLUMN_HELP = 'Status reflects billing and access lifecycle only. Demo/test tenants are filtered separately using database seedSource (demo/e2e), not Trial status.';
