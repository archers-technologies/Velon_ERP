...
exports.NUMBER_FORMAT_OPTIONS = exports.DATE_FORMAT_OPTIONS = exports.TIMEZONE_OPTIONS = exports.CURRENCY_SYMBOLS = exports.COUNTRY_CATALOG = void 0;
exports.getCountryByCode = getCountryByCode;
exports.getCountryDefaultCurrency = getCountryDefaultCurrency;
exports.getCurrencySymbol = getCurrencySymbol;
exports.formatCurrencyLabel = formatCurrencyLabel;
exports.defaultTimezoneForCountry = defaultTimezoneForCountry;
exports.defaultDateFormatForCountry = defaultDateFormatForCountry;
exports.defaultNumberFormatForCountry = defaultNumberFormatForCountry;
exports.formatWorkspaceMoney = formatWorkspaceMoney;
exports.isKnownCountryCode = isKnownCountryCode;
exports.isKnownCurrencyCode = isKnownCurrencyCode;
...
function defaultDateFormatForCountry(code) {
    if (code === 'US')
        return 'MM/DD/YYYY';
    if (code === 'IN' ||
        code === 'GB' ||
...
function defaultNumberFormatForCountry(code) {
    if (code === 'IN')
        return 'en-IN';
    if (code === 'US')
        return 'en-US';
...
function formatWorkspaceMoney(amount, format) {
...
function isKnownCurrencyCode(code) {
